...
public class PrepaidAccountsDto {
	...
	public String toString() {
		return accountId + " , " + customerId + " , " + msisdn + " , " + imsi + " , " + calledStationId + " , "
				+ monitoringKey + " , " + action + " , " + dataParameterType + " , " + csVoiceCallSeconds + " , "
				+ fourGDataOctets + " , " + fiveGDataOctets + " , " + volteCallSeconds + " , "
